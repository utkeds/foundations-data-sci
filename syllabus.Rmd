...
Mondays, 12:00 - 2:30 pm (online and synchronous)
...
give students enough foundational knowledge to pick up new data science
skills on their own after the course is through. This course will serve
as a foundation for later data science in education, including the
second foundations class, data visualization, and machine learning and
the capstone course.
...
|                     | GRADE          |                              |
+=====================+================+==============================+
| Participation       | 12.5%          | 10 / week for 15 weeks = 150 |
| (Readings)          |                | points                       |
+---------------------+----------------+------------------------------+
| Weekly Assignments  | 32.5%          | 30 / week for 13 weeks = 390 |
|                     |                | points                       |
+---------------------+----------------+------------------------------+
| Professional        | 5%             | 60                           |
| Development Plan    |                |                              |
...
-   **Participation: readings, discussions, and in-class activities.**
    There will be weekly readings that focus on the theory and
    principles of data visualization. We will engage with these readings
    through discussions and other in-class activities and apply the
    knowledge gained to our visualization work.
...
-   **Professional development plan:** xx
...
Open AI's GPT-4 and other generative artifcial intelligence tools like
...
+---------------+---------------+---------------+---------------+------+
| **Week**      | **Focal       | **            | **Assignments | **   |
|               | Question and  | Participation | Due by Class  | Data |
|               | Topic**       | (Readings)    | Time**        | Set  |
|               |               | Due by Class  |               | Us   |
|               |               | Time**        |               | ed** |
+---------------+---------------+---------------+---------------+------+
| 1             | What's this   | Week 1        | Install R and |      |
|               | course about? | Reading and   | R Studio      |      |
|               | Introducing   | Discussing    |               |      |
|               | the course    |               | Complete      |      |
|               | and ourselves | Substantive   | primers       |      |
|               |               | reading: xx   |               |      |
|               |               |               | Complete Week |      |
|               |               | Technical     | 0 discussion  |      |
|               |               | reading: xx   |               |      |
+---------------+---------------+---------------+---------------+------+
| 2             | What's all    | Week 2        | Week 1        |      |
|               | the fuss      | Reading and   | Assignment:   |      |
|               | about data    | Discussing    | Creating      |      |
|               | science?      |               | faceted plots |      |
|               | Doing things  | Substantive   | with ggplot2  |      |
|               | we could not  | reading: xx   |               |      |
|               | easily do     |               |               |      |
|               | without       | Technical     |               |      |
|               | advanced      | reading: xx   |               |      |
|               | *graphics*    |               |               |      |
+---------------+---------------+---------------+---------------+------+
| : 3           | What's all    | Week 3        | Week 2        |      |
|               | the fuss      | Reading and   | Assignment:   |      |
|               | about data    | Discussing    | Joining       |      |
|               | science?      |               |               |      |
|               | Doing things  | Substantive   |               |      |
|               | we could not  | reading: xx   |               |      |
|               | easily do     |               |               |      |
|               | without       | Technical     |               |      |
|               | *coding*      | reading: xx   |               |      |
+---------------+---------------+---------------+---------------+------+
| 4             | What counts   | Week 4        | Week 3        |      |
|               | as data?      | Reading and   | Assignment:   |      |
|               | Accessing and | Discussing    | Accessing and |      |
|               | describing    |               | describing    |      |
|               | social media  | Substantive   | Facebook data |      |
|               | data          | reading: xx   |               |      |
|               |               |               |               |      |
|               |               | Technical     |               |      |
|               |               | reading: xx   |               |      |
+---------------+---------------+---------------+---------------+------+
| 5             | What counts   | Week 5        | Week 4        |      |
|               | as data?      | Reading and   | Assignment:   |      |
|               | Accessing and | Discussing    | Accessing and |      |
|               | describing    |               | describing    |      |
|               | public        | Substantive   | Wikipedia     |      |
|               | internet data | reading: xx   | data          |      |
|               |               |               |               |      |
|               |               | Technical     |               |      |
|               |               | reading: xx   |               |      |
+---------------+---------------+---------------+---------------+------+
| 6             | What are the  | Week 6        | Week 5        |      |
|               | core skills I | Reading and   | Assignment    |      |
|               | need to work  | Discussing    |               |      |
|               | with data?    |               |               |      |
|               | Foundational  | Substantive   |               |      |
|               | skills, Part  | reading: xx   |               |      |
|               | 1a            |               |               |      |
|               |               | Technical     |               |      |
|               |               | reading: xx   |               |      |
+---------------+---------------+---------------+---------------+------+
| 7             | What are the  | Week 7        | Week 6        |      |
|               | core skills I | Reading and   | Assignment    |      |
|               | need to work  | Discussing    |               |      |
|               | with data?    |               |               |      |
|               | Foundational  | Substantive   |               |      |
...
|               |               | reading: xx   |               |      |
+---------------+---------------+---------------+---------------+------+
| 8             | What have I   | Week 8        | Mini Project  |      |
|               | done?!?       | Reading and   |               |      |
...
|               |               | reading: xx   |               |      |
+---------------+---------------+---------------+---------------+------+
| 10            | What are the  | Week 10       | Week 9        |      |
|               | core skills I | Reading and   | Assignment    |      |
|               | need to work  | Discussing    |               |      |
|               | with data?    |               |               |      |
|               | Foundational  | Substantive   |               |      |
...
|               |               | reading: xx   |               |      |
+---------------+---------------+---------------+---------------+------+
| 11            | How can I     | Week 12       | Week 10       |      |
|               | prepare for   | Reading and   | Assignment    |      |
|               | the final     | Discussing    |               |      |
|               | project?      |               |               |      |
|               | Learning more | Substantive   |               |      |
|               | and creating  | reading: xx   |               |      |
|               | data products |               |               |      |
|               |               | Technical     |               |      |
|               |               | reading: xx   |               |      |
+---------------+---------------+---------------+---------------+------+
| 12            | How can I use | Week 13       | Data Ethics   |      |
|               | text as data? | Reading and   | Statement     |      |
|               | Tokens and    | Discussing    |               |      |
|               | frequencies   |               |               |      |
|               |               | Substantive   |               |      |
|               |               | reading: xx   |               |      |
|               |               |               |               |      |
...
|               |               | reading: xx   |               |      |
+---------------+---------------+---------------+---------------+------+
| 13            | How can I use | Week 14       | Week 12       |      |
|               | text as data? | Reading and   | Assignment    |      |
...
|               |               | reading: xx   |               |      |
+---------------+---------------+---------------+---------------+------+
| 14            | How can I use | Week 15       | Week 13       |      |
|               | text as data? | Reading and   | Assignment    |      |
|               | Term          | Discussing    |               |      |
|               | co-occurences |               |               |      |
|               |               | Substantive   |               |      |
...
|               |               | reading: xx   |               |      |
+---------------+---------------+---------------+---------------+------+
| 15            | How can I     | Week 16       | Week 14       |      |
|               | share my      | Reading and   | Assignment    |      |
|               | work?         | Discussing    |               |      |
|               | Blogdown and  |               |               |      |
|               | GitHub        | Substantive   |               |      |
|               |               | reading: xx   |               |      |
