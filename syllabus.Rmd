...
+-------------+-------------+-------------+----------------------+
| -           | **Date**    | **Focal     | **Assignments Due    |
|  \*Semester |             | Question    | Before the Next      |
|     W       |             | and Topic** | Class**              |
|     eek\*\* |             |             |                      |
+-------------+-------------+-------------+----------------------+
| 1           | N/A         | What's R?   | Primers              |
|             |             | Getting     |                      |
|             |             | Setup       | Weekly reading and   |
|             |             |             | discussion           |
+-------------+-------------+-------------+----------------------+
| 2           | August 28   | What's this | Week 2 Assignment:   |
|             |             | course      | Install R and R      |
|             |             | about?      | Studio, Simple code  |
|             |             | Introducing | walkthrough; use     |
|             |             | the course  | janitor, "skim" a    |
|             |             | and         | data set to get a    |
|             |             | ourselves   | feel for the data,   |
|             |             |             | **and answer some    |
|             |             |             | questions** (what's  |
|             |             |             | the average? what's  |
|             |             |             | your state? what's   |
...
|             |             |             | discussion           |
+-------------+-------------+-------------+----------------------+
| 3           | S eptember  | What's all  | Week 3 Assignment:   |
|             | 4           | the fuss    | Creating faceted     |
|             |             | about data  | plots with ggplot2 - |
|             |             | science?    | drill down into      |
|             |             | Doing       | group-specific       |
|             |             | things we   | *patterns* within    |
|             |             | could not   | federal school data  |
|             |             | easily do   |                      |
|             |             | without     | Weekly reading and   |
|             |             | advanced    | discussion           |
|             |             | *graphics*  |                      |
+-------------+-------------+-------------+----------------------+
| 4           | S eptember  | What's all  | Week 4 Assignment:   |
|             | 11          | the fuss    | Joining multiple     |
|             |             | about data  | frames -- join two   |
|             |             | science?    | unrelated data sets  |
|             |             | Doing       | together and examine |
|             |             | things we   | the correlation -    |
|             |             | could not   | tidykids spending -  |
|             |             | easily do   | pk12 spending        |
...
|             |             |             | discussion           |
+-------------+-------------+-------------+----------------------+
| 5           | S eptember  | How do I    | Week 5 Assignment:   |
|             | 18          | access and  | Accessing and        |
|             |             | describe    | describing data -    |
|             |             | data? Using | using the            |
|             |             | an R        | educationdata        |
|             |             | package and | package to query an  |
|             |             | an API      | API                  |
|             |             |             |                      |
|             |             |             | Weekly reading and   |
|             |             |             | discussion           |
+-------------+-------------+-------------+----------------------+
| 6           | S eptember  | How do I    | Week 6 Assignment:   |
|             | 25          | preparing   | Foundational data    |
|             |             | data for    | wrangling, part 1 -  |
|             |             | analysis    | Making a better      |
|             |             | ?F          | college rating using |
|             |             | oundational | college data - using |
|             |             | skills,     | educationdata        |
|             |             | Part 1a     | college-university   |
|             |             |             | end points           |
|             |             |             |                      |
|             |             |             | Weekly reading and   |
|             |             |             | discussion           |
...
|             |             | data?       | Making a better      |
|             |             | F           | college rating using |
|             |             | oundational | college data - using |
|             |             | skills,     | educationdata        |
|             |             | Part 1b     | college-university   |
|             |             |             | end points           |
|             |             |             |                      |
|             |             |             | Weekly reading and   |
|             |             |             | discussion           |
...
|             | Break)      |             |                      |
+-------------+-------------+-------------+----------------------+
| 9           | October 16  | How do I    | Week 9 Assignment,   |
|             |             | access      | Scraping Wikipedia   |
|             |             | public      |                      |
|             |             | Internet    | Weekly reading and   |
|             |             | data? Web   | discussion           |
|             |             | scraping    |                      |
+-------------+-------------+-------------+----------------------+
| 10          | October 23  | What have I | Mini Project -- \<   |
|             |             | done?!?     | <https:              |
|             |             | Sharing     | //data.utk.edu/>\> - |
|             |             | work        | Calculating          |
|             |             | (Quarto,    | descriptive stats    |
|             |             | Rmd and its | from a survey to     |
|             |             | friends)    | share with           |
|             |             | and         | instructors and      |
|             |             | Presenting  | administrators OR    |
|             |             | Mini        | Making a better      |
|             |             | Project     | college rating using |
|             |             |             | college data OR Use  |
|             |             |             | student performance  |
|             |             |             | data over several    |
|             |             |             | years to identify    |
...
|             |             |             | discussion           |
+-------------+-------------+-------------+----------------------+
| 11          | October 30  | What are    | Week 11 Assignment,  |
|             |             | the more    | Advanced data        |
|             |             | complex     | wrangling and        |
|             |             | skills I    | visualization, part  |
|             |             | need to     | 1 - **Building a     |
|             |             | work with   | dashboard using      |
|             |             | data?       | learning analytics   |
|             |             | F           | data - candidate -** |
|             |             | oundational | prep for the         |
|             |             | skills,     | dashboard; getting   |
|             |             | Part 2a     | teh data ready       |
|             |             |             |                      |
|             |             |             | Weekly reading and   |
|             |             |             | discussion           |
+-------------+-------------+-------------+----------------------+
| 12          | November 6  | What are    | Week 12 Assignment,  |
|             |             | the core    | Advanced data        |
|             |             | skills I    | wrangling and        |
|             |             | need to     | visualization, part  |
|             |             | work with   | 2 - building a beta  |
|             |             | data?       | version of dashboard |
|             |             | F           | with a single plot   |
|             |             | oundational |                      |
|             |             | skills,     | Weekly reading and   |
|             |             | Part 2b     | discussion           |
+-------------+-------------+-------------+----------------------+
| 13          | November 13 | How can I   | Week 13 Assignment,  |
|             |             | prepare for | Mapping Achievement  |
|             |             | the final   | Gaps: Use school     |
|             |             | project?    | performance data and |
|             |             | Learning    | district shape files |
|             |             | more and    | to create a map to   |
|             |             | creating    | understand           |
|             |             | data        | achievement gaps. -  |
...
|             |             |             | discussion           |
+-------------+-------------+-------------+----------------------+
| 14          | November 20 | How can I   | Week 14 Assignment,  |
|             |             | use text as | Text analysis, part  |
|             |             | data?       | 1 - social media     |
|             |             | Tokens and  | data... CrowdTangle  |
|             |             | frequencies | data on climate      |
|             |             |             | change (you can      |
|             |             |             | parse for            |
|             |             |             | educational          |
|             |             |             | implications or      |
...
|             |             |             | discussion           |
+-------------+-------------+-------------+----------------------+
| 15          | November 27 | How can I   | Week 15 Assignment,  |
|             |             | use text as | Text analysis, part  |
|             |             | data?       | 2 - student comments |
|             |             | Sentiment   | (Ryan and/or Rita    |
|             |             | and term    | and Josh)            |
|             |             | c           |                      |
|             |             | ooccurences | Accessing and        |
|             |             |             | describing social    |
|             |             |             | media and public     |
|             |             |             | internet data        |
|             |             |             |                      |
...
|             |             |             | discussion           |
+-------------+-------------+-------------+----------------------+
| 16          | December 4  | Final       | Weekly reading and   |
|             |             | Projects    | discussion           |
+-------------+-------------+-------------+----------------------+
...
+-------------+-------------+-------------+------------------------+
| **Semester  | -           | **          | **Tutorial             |
| Week**      |  \*Date\*\* | Substantive | Reading(s)**           |
|             |             | R           |                        |
|             |             | eading(s)** |                        |
+-------------+-------------+-------------+------------------------+
| 1           | N/A         | Estrellado, | We can                 |
|             |             | R. A.,      |                        |
|             |             | Freer, E.   |                        |
|             |             | A.,         |                        |
|             |             | Mostipak,   |                        |
