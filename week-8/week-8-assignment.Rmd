...
As noted in this week's class, we will be using data similar to that we accessed from the educationdata R package. For simplicity and to focus more on grouping and summarizing, I've provided a CSV with the data in Canvas; you can read it as follows:

```{r}
elsi_data <- read_csv(___, skip = 6)
