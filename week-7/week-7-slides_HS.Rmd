...
- What went well in the last week's assignment?
...
<small>
> There is no "right" way to rank these colleges, or one that is necessarily better than the other. Instead it's more important to use the ranking that matters more to you. If you want to go to a college that is really into giving to their community or has a lot of funding for students, you may use a different ranking system. Therefore its not truly how they rank them that matters, it matters most how open they are on how they come to their rankings so that you can determine which list you would like to use. -- Lauren

> I lean towards the word useful rather than good, following the critique made in the Washington Monthly article. I also think usefulness is relative; is the ranking designed to be useful to prospective students or researchers, or government/policy makers? I think the ranking system audience should be a factor to be considered in evaluating whether a ranking system is useful or not. -- Sulaimon

> I looked at U.S. News ranking when choosing graduate schools, but I quickly realized that ranking don't capture whether a program is the right fit. Rankings can be helpful starting point, but after narrowing down schools by rank, I dug deeper into each program, looking at faculty, research areas, and even checking LinkedIn to see academic achievements and career paths of alumni. That gave me a much clearer picture than ranking alone. -- Xin (Lydia)
...
.panel[.panel-name[Next week: Fall break (NO CLASS)]

- Next week is Fall break (10/6-7), so we will not meet for class. All assignments are due by Sunday (10/12 Sunday 11:59 pm). Wishing you a restful break!
