...
1. What went well in the last week's assignment?
2. What issues, if any, did you encounter in the last week using the Education Data Portal API via the educationdata R package? How did you overcome them---or try to overcome them?
3. Did you find anything interesting and how would you extend your analysis?

Please share your experiences briefly in here [Week 8 - Lecture Discussion](https://utk.instructure.com/courses/253707/discussion_topics/1972236)
]
...
> <b>Key insight</b>: Rankings reflect the priorities embedded in the data and metrics.

> <b>Takeaway message</b>: Rankings are not neutral; they reflect <i>analytical choices</i>.
...
.panel[.panel-name[Next week: Regular check-in (Synch session)]

Next week, we will have our regular check-in session (sychronous), which is **required to attend**. I've already sent an outlook calendar invitation with the Zoom link. See you next week!
