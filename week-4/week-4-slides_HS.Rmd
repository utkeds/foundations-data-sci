...
- Describe what you want to achieve to find any posts on stack overflow or get assistance from GenAI (I'd encourage you to use PingPong AI in STEM 680, but ChatGPT is an option too)
...
<small>
> Language shapes perception, so saying "students with disabilities" rather than saying "disabled students" puts the person before the descriptor.  Framing the labels influences how people interact with the data and the groups represented. -- Rhea

> In reality, some people may take advantage of data visualization for misleading. For instance, if only the total number of military personnel is counted, China ranks first in the world, but on a per capita basis, the figure is relatively small. Such presentations are prone to causing misunderstandings and spreading false information. -- Qi

> "Counter Mapping" is the process of telling a story of a group of people for example, and portraying a message that they are wanting delivered. Here is a cool example of counter mapping [(link)](https://emergencemagazine.org/film/counter-mapping/). This is a short film (under 10 mins) about creating maps that have an indigenous voice. In the film one thing that is mentioned that directly correlates to this principle is that fact that he believes indigenous people have lost more land from mapping than conflicts. -- Andrea

> And so forth... <u>Please revisit Week 3 reading assignment to read others' posts!</u> Thank you all for your excellent work!
