...
This week, we answer the following question: What's all the fuss about data science? We'll dive into creating data visualizations --- with a focus on a particular format of a graph that is well-suited to the exploration of complex data sets, _facets_.
...
In advance of this class, you were tasked with one substantive reading:
