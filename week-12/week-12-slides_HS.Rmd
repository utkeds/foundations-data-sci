...
#| out.width: 60%
#| fig-align: center
knitr::include_graphics("head(nc).png")
```
]
...
#| out.width: 80%
#| fig-align: center
knitr::include_graphics("tn_districts.png")
```
]
...
- Be sure to turn in your mini-project and final project plans if you haven't already.
...
> Introduction to text analysis with the tidytext package (https://www.tidytextmining.com/tidytext.html)
