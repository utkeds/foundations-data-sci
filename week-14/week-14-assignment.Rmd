...
*Note --- you may not have data you can use. That's okay, and we have some backup data in such cases. You can uncomment the line in the code chunk below to download data from discussions from Massively Open Online Courses for Educators (MOOC-Ed) at NC State Unviersity. Specifically, the data is from a MOOC-Ed course on Teaching Statistics.*
