...
- Discussion
- Key Concept: Topic modeling | Document-term matrix | the Topicmodels package
- Code-along and data
...
TNVoice (TN Volunteer Online Instructor & Course Evaluations) will open to students on **Wednesday, April 23** at 12:01 am and will remain open until 11:59 pm on **Wednesday, May 8**.
...
- What do you see as the potential of analyzing text with your computer? What challenges and opportunities do we have?
...
- Lastly, using your own data may be hard; you shouldn't look for perfect or even very good output, instead celebrating any results/output you can produce with their data! That's what we're looking for from this assignment.
    - There's also a backup dataset you can use if you don't have one - details in the assignment RMD file on how they can read it directly in from GitHub.
    
]

.panel[.panel-name[Final Projects]

- How are you doing? Your final project _presentation video uploading_ is coming up soon (Due May 6)! Please see details here(https://utk.instructure.com/courses/224781/discussion_topics/1699555?module_item_id=5201224)
- Next week (Week 15),
    - Due to my expected delivery, it's (very much) likely that I will post a **Zoom lecture recording** instead of holding a live synchronous session. If so, I’ll send out a brief announcement email along with the video link. Please plan to view the lecture asynchronously. Thank you so much for your understanding and flexibility!
    - We’ll also reserve some time next week for preparing your final project presentations, meaning that lecture will be shorter than usual.
    - Just a reminder: your final reports will be due on **May 13**, following the video uploading of your presentations.


]

.panel[.panel-name[Data Ethics Statement]

- Let us now check that you can see the assigned peer for peer review in Canvas.
- Peer review on others' data ethics statement is due next Monday **(April 28, 11:59 pm)**
- Please see details here(https://utk.instructure.com/courses/224781/assignments/2142244)
