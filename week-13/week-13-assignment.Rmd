...
In this step, determine how many times the instructor spoke the utterance "um" over the class. Hint: use code similar to Steps 2 and 3. As a reach, calculate the mean number of "um" utterances per minute spoken (you may need to use the package lubridate). 
...
As a reach, conduct a sentiment analysis on the Zoom transcript data from class. To see code on how to do this, visit: http://zoomgroupstats.org/articles/part03-analyze-zoom-conversation-data.html#:~:text=the%20transcript%20file.-,Performing,-sentiment%20analysis
