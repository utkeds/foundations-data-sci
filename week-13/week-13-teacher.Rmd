...
In this step, determine how many times Isabella or Maryrose (you pick) spoke the word "data" over the class. Hint: use code similar to Steps 2 and 3. As a reach, calculate the mean number of "data" words per minute spoken (you may need to use the package lubridate). 
...
isabella_data_1 <- transcript %>% 
  ...
  mutate(hour = hour(start),
         minute = minute(start)) 
data$time <- paste(data$hour,data$minute)
