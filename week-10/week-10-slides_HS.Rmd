...
* Starting next week, __all readings are optional__. That means, we don't have reading assignments from next week.
* Still, we'll have the lecture discussion activity. Some mentioned they loved to see others' reflections, which I highly value!
* Starting next week, I'll include a brief weekly assignment review at the beginning of class.
* Slack channel for our class: [link](https://eddatascienceatutk.slack.com/archives/C0APVGGRYRG) 
...
> Real-world data is messy (i.e., Real-world data is not _tidy_ by default).

> We must structure it before analysis.
