...
1. What are some use cases for your research (past, current, or planned) that involve multiple data files? And, why might it be important to join those files together?

2. From a research perspective, how might integrating diverse data sources deepen understanding or open up new insights in your field of study?

3. What challenges or issues do you anticipate when combining data from various sources in your field or any other fields, like industry?

Please share your ideas briefly here: [Week 5 - Discussion](https://utk.instructure.com/courses/253707/discussion_topics/1961014)
