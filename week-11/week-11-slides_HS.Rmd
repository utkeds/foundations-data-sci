...
elsi_data <-
    readr::read_csv(
        "https://github.com/utkeds/foundations-data-sci/blob/S25-foundations-eds/data/ELSI_csv_export_6383262475806903427192.csv?raw=true",
        skip = 6
    ) %>% janitor::clean_names()
```
...
- Comments & recommendations on final project plan (**will be provided by end of this week**) 
- Revisit Key Concepts from Assignment 8
...
* Please review the comments on your final projects and follow up if necessary (will be provided **by end of this week**) 
