...
How can we make sense of complex data by identifying patterns and trends? This week focuses on grouping and summarizing data; it is the week that equips you with core skills for transforming detailed datasets into meaningful insights using group_by() and summarise() in the tidyverse. Building on last week’s data wrangling work, we will focus on how to aggregate data across different levels and interpret those summaries in context.
...
Please complete it now: https://forms.gle/qXdqqJnDtEWpENyMA 

* Course-related or general questions
* Troubleshooting questions or anything related to assignments
* Any other concerns

Plz don't hesitate to reach out to me! (hanallsung@utk.edu)
...
> Theme 1: Educational data is inherently complex because it exists at multiple levels; micro, meso, and macro.

> Theme 2: The importance of aggregation

> --> **No single level of data tells the full story!**
...
- As we discussed in our last class (for week 8), there are several functions loaded in the dplyr package (which itself is loaded in the tidyverse package) that are useful in practically all analyses: `select()`, `rename()`, `filter()`, `arrange()`, and `mutate()`
...
.panel[.panel-name[Mini-Project (Due in 2 weeks)]

- The mini-project is now available in Canvas [(Link)](https://utk.instructure.com/courses/253707/assignments/2632151?module_item_id=6149104)! You will be using recent data from the Tennessee Department of Education. While the data is specified, the analyses you conduct to answer two questions of the data are more open-ended in nature. You'll have ***two weeks (Due 11:59 pm on Sunday)*** to complete this, to allow for time for you to ask questions and dig deep into the data. 
