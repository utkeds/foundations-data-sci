...
> I think the ethics of the research in both articles are in question. While Rosenburg et. al and Rosenburg et. al aimed to use their respective datasets for “good”, it is unclear if the data in question was consented for use by the users. -- Jimmy

> ... the Facebook study calls attention to a much more fundamental problem with data privacy in the digital age, underscoring the idea that even legally obtained data may still pose risks to individuals’ privacy. Hence, scholars and policymakers should look beyond legal compliance to ethical obligations and embrace stronger privacy-protection ethics. -- Olusegun

> The ethics of accessing this data were particularly important, as the researchers had to balance the public nature of the posts with the potential harm to students’ privacy. By carefully adhering to ethical guidelines for social media research, they sought to mitigate risks of exposing sensitive information about students while still drawing meaningful insights from publicly available content. -- Jerri
...
> How U.S. News Calculated the 2024 Best Colleges RankingsLinks to an external site.

> A different kind of college rankingLinks to an external site.
...
> Using School-Level Aggregate Data to Illuminate Educational InequitiesLinks to an external site.
